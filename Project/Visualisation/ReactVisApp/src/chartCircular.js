...
export class ChartCircular extends React.Component {
    ...
    createChart() {
        ...
        for (let tag_ix = 0; tag_ix < genres_tmp.length; tag_ix++) {
            ...
            //const filtered_set = new Array(... new Set(this.state.data.sets.flatMap(x => x['labels'])))
    ...
    render() {
        let svg_list = <svg ref={'allchartsvg'} width={this.props.width} height={this.props.height} style={{margin: "auto",textAlign:"center" }}></svg>
