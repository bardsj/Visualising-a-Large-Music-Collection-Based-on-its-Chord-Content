...
export default () => {
  ...
  const [requestParams, setRequestParams] = useState({tag_val:["jazz"], tag_name:"genres",chartType:"Parallel Sequence",focus:1,support:1,beta:1,optType:null,cPath:false,majMinSel:false})
